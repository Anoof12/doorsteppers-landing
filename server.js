...
// Seed initial entries on every startup (INSERT OR IGNORE — won't overwrite real signups)
function seedInitialEntries() {
  ...
  for (const e of seedEntries) {
    stmt.run(e.full_name, e.email, e.location, e.services, e.want_to_be_stepper, e.customer_type, e.would_pay, e.submitted_at);
  }
  console.log('Seed entries ensured.');
}
